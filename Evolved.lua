...
function gruzchik()
    newTask(function()
        while true do
            ...
            printm("Взял мешок с зерном. Жду 5 секунд перед следующим тп для того что-бы не кикнуло.")
            wait(5000)
            tp(2163.060546875, -2238.1853027344, 13.287099838257)
            tp(2167.7253417969, -2262.1433105469, 13.30480670929)
            printm("Отнёс мешок с зерном. Жду 5 секунд перед следующим тп для того что-бы не кикнуло.")
            wait(5000)
        end
    end)
end